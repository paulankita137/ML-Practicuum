...
train_set_cad_high_data, test_set_cad_high_data = train_test_split(cad_high_data,test_size=0.8,random_state=42)

# Train/Test Sets
cad_data_tr = train_set_cad_data.copy()
cad_data_test = test_set_cad_data.copy()

cad_high_data_tr = train_set_cad_high_data.copy()
